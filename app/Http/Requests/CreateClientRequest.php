...
class CreateClientRequest extends FormRequest {
    ...
    public function rules() {
        return [
                ...
                'time_zone'=> 'required',
                'currency'=> 'required',
                'default_price_sms'=> 'required|min:0.005',
                'sender' => 'required',
    ...
    public function messages()
    {
        return [
                ...
                'currency.required'   => trans('validationForm.currency_select.required'),
                ...
                'billing_type.required'   => trans('validationForm.billing_type.required'),
        ];
    }
}
